...
<h3>사원 번호를 정해 업데이트</h3>
<form action="${pageContext.servletContext.contextPath}/employeesz" method="post">
    변경할 사원 번호 : <input type="number" name="empId"> <br>
    <br>
    <br>
    <h3>변경할 사원의 신상정보를 입력 해주세요</h3>
