...
<body>
    ...
    <form action="query-string" method="get">
        ...
        <input type="checkbox" name="hobbies" id="sleep" value="sleep"/><label for="sleep">잠</label>
    ...
    <form action="post-request" method="post">
        ...
        <input type="checkbox" name="hobbies" id="sleep2" value="sleep"/><label for="sleep2">잠</label>
        <button type="submit">전송하기</button>
    </form>
